...
def main():
    ...
    if not st.session_state["edit_mode"]:
        st.markdown(f"<div style='font-size:1.2em; line-height:1.7; margin-bottom:1.5em;'>{st.session_state['summary'].replace(chr(10),'<br>')}</div>", unsafe_allow_html=True)
        ...
        new_summary = st.text_area("Edit Summary", value=st.session_state["summary"], height=300, key="summary_edit")
